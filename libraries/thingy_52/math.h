...
#if (__MISC_VISIBLE || (__XSI_VISIBLE && __XSI_VISIBLE < 600)) && (!defined(__cplusplus) || __cplusplus < 201103L)
...
#else
#define signbit(__x) ((sizeof(__x) == sizeof(float)) ? __builtin_signbitf(__x) : __builtin_signbit(__x))
#endif
#else
