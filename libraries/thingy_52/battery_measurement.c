...
{
   drv_ext_gpio_cfg_output(BAT_MON_EN_PIN_NO);
   drv_ext_gpio_pin_set(BAT_MON_EN_PIN_NO);     // Enable battery monitoring.
   drv_ext_gpio_pin_clear(BAT_MON_EN_PIN_NO);     // Disable battery monitoring to save power.
}
